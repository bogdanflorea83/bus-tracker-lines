...
public class Point implements Serializable, JSONAware {
	...
	public String toJSONString() {
		 return "{\"lat\": " + JSONValue.toJSONString(lat) + ", \"lng\": " +JSONValue.toJSONString(lng) + ", \"geohash\": "+ JSONValue.toJSONString(GeoHashUtils.encode(lat, lng, 10))+"}";		
	}
